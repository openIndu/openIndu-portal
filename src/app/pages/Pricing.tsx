      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* On-Premises */}
            <div className="border-2 border-gray-200 rounded-xl p-8 hover:border-sky-600 transition-all">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-sm text-gray-700">openEuler + 国产芯片基础</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              ...
              <a href="mailto:info@openindu.com" className="block w-full px-4 py-2 bg-sky-700 text-white rounded-lg hover:bg-[#085A90] text-center transition-colors">
                咨询部署
              </a>
            </div>

            {/* Edge Computing */}
            <div className="border-2 border-sky-600 rounded-xl p-8 relative">
              <div className="absolute top-4 right-4 bg-sky-700 text-white px-3 py-1 rounded-full text-xs font-semibold">
                推荐
              </div>
              <div className="w-12 h-12 rounded-lg bg-sky-100 flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-gray-600 mb-6 leading-relaxed">
                国产工控芯片 + openEuler 软PLC 一体化方案，开箱即用
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-sm text-gray-700">国产工控芯片预装</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              ...
              <button className="w-full px-4 py-2 bg-sky-700 text-white rounded-lg hover:bg-[#085A90] text-center transition-colors">
                获取报价
              </button>
            </div>
            ...
            <div className="border-2 border-gray-200 rounded-xl p-8 hover:border-sky-600 transition-all">
              <div className="w-12 h-12 rounded-lg bg-sky-100 flex items-center justify-center mb-4">
                <Github className="w-6 h-6 text-sky-700" />
              </div>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Enterprise */}
            <div className="bg-white rounded-lg p-8 border-2 border-sky-600">
