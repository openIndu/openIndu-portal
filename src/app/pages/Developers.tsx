      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-white to-cyan-50 py-16 sm:py-24 overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold mb-5">
            ...
            {quickStartSteps.map((step) => (
              <div key={step.num} className="flex gap-6">
                ...
                <div className="flex-grow pt-1">
                  ...
                  {step.link && (
                    <a href={step.link} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 mt-2 inline-flex items-center gap-1">
              ...
              <a key={resource.title} href={resource.href} target="_blank" rel="noopener noreferrer" className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-grow">
                    ...
                    <span className="text-blue-600 text-sm mt-2 inline-flex items-center gap-1">
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
              ...
              <a href="https://github.com/openIndu/openIndu-studio" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 text-sm inline-flex items-center gap-1">
            ...
            <div className="rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
              ...
              <a href="https://github.com/openIndu/openIndu-platform" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 text-sm inline-flex items-center gap-1">
                Explore <ArrowRight className="w-3 h-3" />
              </a>
            </div>
            <div className="rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
              ...
              <a href="https://github.com/openIndu/openindu-station" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 text-sm inline-flex items-center gap-1">
                Explore <ArrowRight className="w-3 h-3" />
              </a>
            </div>
          </div>
